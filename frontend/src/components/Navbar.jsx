      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-3">
        ...
        <div className="collapse navbar-collapse">
          <ul className="navbar-nav me-auto gap-2">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/cus_receipts">
                Customer Receipt
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/sub_receipts">
                Supplier Receipt
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/cancelled-orders">
                Cancelled Orders
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/stockledger">
                StockLedger
              </Link>
            </li>
            <li className="nav-item">
